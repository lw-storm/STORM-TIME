...
| **安卓手机端** | 扫码配对一次，手机随身查看与记录——自动同步、离线可写、壁纸头像外观同步 |
...
<table><tr>
<td><img src="docs/screenshots/p1-phone-chat.png" width="230" alt="手机端对话"></td>
<td><img src="docs/screenshots/p2-phone-todo.png" width="230" alt="手机端待办"></td>
</tr></table>
